# Biomechanics-ML
Pipeline de ML com visão computacional para análise de marcha — do vídeo à decisão assistida por IA. Sports2D, scikit-learn e SHAP, enquadrados pelos pilares do framework [Reality-Centric AI]([http://exemplo.com/](https://www.vanderschaar-lab.com/the-case-for-reality-centric-ai/)).
